              ...
              children: <Widget>[
                ...
                SizedBox(
                  ...
                  child: GridView(
                    ...
                    children: data.sizes.map((size) => GestureDetector(
                      onTap: () {
                        setState(() {
                          this.size = size;
                        });
                  ...
                  child: RaisedButton(
                    onPressed: size != null ? (){
                      if (UserModel.of(context).isLoggedIn()) {
                        CartProduct cartProduct = CartProduct(data.id, data.categoryId, 1, size);
                        CartModel.of(context).addItem(cartProduct);
                      } else {
